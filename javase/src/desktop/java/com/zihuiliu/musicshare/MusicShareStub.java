...
package com.zihuiliu.musicshare;
 ...
 * @author Shai Almog
 */
public class MusicShareStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MusicShare";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MusicShareStub());
    }
